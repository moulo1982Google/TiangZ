...
(() => {
  ...
  globalThis.__etsNativeOps = Object.freeze({
    ...
    spatialRaycast: (mapId, startX, startY, startZ, endX, endY, endZ, extentX, extentY, extentZ) => core.ops.op_native_spatial_raycast(u32(mapId, "mapId"), f64(startX, "startX"), f64(startY, "startY"), f64(startZ, "startZ"), f64(endX, "endX"), f64(endY, "endY"), f64(endZ, "endZ"), f64(extentX, "extentX"), f64(extentY, "extentY"), f64(extentZ, "extentZ")),
    spatialSampleHeight: (mapId, x, y, z, extentX, extentY, extentZ) => core.ops.op_native_spatial_sample_height(u32(mapId, "mapId"), f64(x, "x"), f64(y, "y"), f64(z, "z"), f64(extentX, "extentX"), f64(extentY, "extentY"), f64(extentZ, "extentZ")),
    spatialUpsertBoxObstacle: (mapId, obstacleId, centerX, centerY, centerZ, halfX, halfY, halfZ, yawRadians) => core.ops.op_native_spatial_upsert_box_obstacle(u32(mapId, "mapId"), u32(obstacleId, "obstacleId"), f64(centerX, "centerX"), f64(centerY, "centerY"), f64(centerZ, "centerZ"), f64(halfX, "halfX"), f64(halfY, "halfY"), f64(halfZ, "halfZ"), f64(yawRadians, "yawRadians")),
    spatialRemoveObstacle: (mapId, obstacleId) => core.ops.op_native_spatial_remove_obstacle(u32(mapId, "mapId"), u32(obstacleId, "obstacleId")),
    spatialUpdateObstacles: (mapId, maxCommands, maxTileUpdates) => core.ops.op_native_spatial_update_obstacles(u32(mapId, "mapId"), u32(maxCommands, "maxCommands"), u32(maxTileUpdates, "maxTileUpdates")),
    ...
    unitRelocate: (mapId, handle, x, y, z, yaw) => core.ops.op_native_unit_relocate(u32(mapId, "mapId"), u32(handle, "handle"), f64(x, "x"), f64(y, "y"), f64(z, "z"), f64(yaw, "yaw")),
    ...
    unitSetGridMovementTarget: (handle, targetCellX, targetCellZ, sequence) => core.ops.op_native_unit_set_grid_movement_target(u32(handle, "handle"), i32(targetCellX, "targetCellX"), i32(targetCellZ, "targetCellZ"), u32(sequence, "sequence")),
    unitApplyGridMovementSnapshot: (handle, cellX, height, cellZ, yaw, moving, sequence) => core.ops.op_native_unit_apply_grid_movement_snapshot(u32(handle, "handle"), i32(cellX, "cellX"), f64(height, "height"), i32(cellZ, "cellZ"), f64(yaw, "yaw"), bool(moving, "moving"), u32(sequence, "sequence")),
