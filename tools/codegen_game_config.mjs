...
async function writeTarget(target, outputRoot, generated, fingerprints) {
  ...
  await writeFile(
    ...
    `// Generated by tools/codegen_game_config.mjs. Do not edit.\nexport * from "./GameConfigs";\nexport { ActionType, BuffConflictPolicy, BuffRefreshStatePolicy, BuffRefreshTickPolicy, BuffStackScope, ConfigReloadMode, SkillAutoAttackPolicy, SkillDelivery, SkillEffectTarget, SkillMovementPolicy, SkillTargetRelation, SpatialMode, game } from "./schema";\n`,
    "utf8",
  );
}
...
function validateRawAction(owner, type, parameters, buffIds, allowEmptyRemove) {
  if (!Number.isSafeInteger(type) || type < 0 || type > 6 || !Array.isArray(parameters)) {
