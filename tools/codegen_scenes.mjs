...
const patchFiles = await collectFiles(patchSearchRoots, isPatchFile);
...
await recordGenerator(root, {
  ...
  selections: [
    ...
    { kind: "hotfix-patch", roots: patchSearchRoots, paths: patchFiles },
  ...
  outputs: [outputFile, handlerOutputFile, patchOutputFile, benchHandlerOutputFile],
  outputRoots: [
