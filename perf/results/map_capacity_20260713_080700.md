...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 180 | 88/91/91% | 44/46.4% | 1790 | 99.4% | 321615 | 180 | 22.02ms | 43.56ms | 52.55ms | 69.93ms | 108.19ms | 0/0 | 0/0 | 993.5MB |

## 容量判断

- 本轮没有同时满足 CPU 目标、零超时、零内部过载的容量点。
- 最接近 85% 的测试点：180 玩家，Map CPU 平均 88%。
