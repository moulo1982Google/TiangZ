...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 100 | 55.2/78.3/78.3% | 34.5/45.6% | 1000 | 100% | 100000 | 100 | 1.89ms | 5.85ms | 15.86ms | 25.81ms | 28.09ms | 0/0 | 0/0 | 572.4MB |

## 批量下行 Bridge

| 玩家 | Gate batch/s | recipients/s | recipients/batch | Bridge copy | logical outbound |
|---:|---:|---:|---:|---:|---:|
| 100 | 8100 | 100111 | 12.36 | 0.11MB/s | 1.34MB/s |

## 容量判断

- 保守容量点：100 玩家，Map CPU 平均 55.2%，Probe p95/p99 15.86/25.81ms。
- 最接近 85% 的测试点：100 玩家，Map CPU 平均 55.2%。
