...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 200 | 145.6/154.4/154.4% | 197.9/240% | 2000 | 100% | 399985 | 193 | 24.86ms | 74.19ms | 91.78ms | 113.71ms | 174.34ms | 0/0 | 0/0 | 668.3MB |

## 容量判断

- 本轮没有同时满足 CPU 目标、零超时、零内部过载的容量点。
- 最接近 85% 的测试点：200 玩家，Map CPU 平均 145.6%。
