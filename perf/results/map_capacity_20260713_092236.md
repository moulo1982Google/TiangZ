...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 200 | 130.8/141.8/141.8% | 171.1/195.5% | 2000 | 100% | 400000 | 200 | 14.22ms | 53.71ms | 67.41ms | 99.6ms | 117.01ms | 0/0 | 0/0 | 761.2MB |

## 容量判断

- 本轮没有同时满足 CPU 目标、零超时、零内部过载的容量点。
- 最接近 85% 的测试点：200 玩家，Map CPU 平均 130.8%。
