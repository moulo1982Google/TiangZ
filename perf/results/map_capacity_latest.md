...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 525 | 69.1/83/83% | 68.6/82% | 2625 | 100% | 1378125 | 525 | 8.47ms | 72.65ms | 85.62ms | 106.59ms | 150.1ms | 0/0 | 0/0 | 966.1MB |

## 批量下行 Bridge

| 玩家 | Gate batch/s | recipients/s | recipients/batch | Bridge copy | logical outbound |
|---:|---:|---:|---:|---:|---:|
| 525 | 32034 | 1379062 | 43.05 | 0.41MB/s | 17.92MB/s |

## 容量判断

- 保守容量点：525 玩家，Map CPU 平均 69.1%，Probe p95/p99 85.62/106.59ms。
- 最接近 80% 的测试点：525 玩家，Map CPU 平均 69.1%。
