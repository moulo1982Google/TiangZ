...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 185 | 107.5/119.6/119.6% | 90.1/132.7% | 1850 | 100% | 342250 | 185 | 8.59ms | 37.82ms | 47.65ms | 62.62ms | 97.41ms | 0/0 | 0/0 | 776.0MB |

## 容量判断

- 本轮没有同时满足 CPU 目标、零超时、零内部过载的容量点。
- 最接近 85% 的测试点：185 玩家，Map CPU 平均 107.5%。
