...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 200 | 92.5/102.1/102.1% | 55.5/72.8% | 2000 | 100% | 400000 | 200 | 7.5ms | 23.14ms | 27.04ms | 32.93ms | 39.55ms | 0/0 | 0/0 | 854.0MB |

## 容量判断

- 本轮没有同时满足 CPU 目标、零超时、零内部过载的容量点。
- 最接近 85% 的测试点：200 玩家，Map CPU 平均 92.5%。
