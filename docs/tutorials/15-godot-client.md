...
`../TiangZ-Examples/clients/godot-3d-4.7.1`是TiangZ的Godot 4.7.1 GDScript灰盒客户端。它和Cocos3D、UE 5.4.4使用相同的服务端坐标、Map 100、NavMesh移动和动态门协议，目的是验证“引擎只负责表现，服务端负责权威空间状态”。
...
```text
../TiangZ-Examples/clients/godot-3d-4.7.1/project.godot
```
