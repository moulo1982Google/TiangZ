...
- `SkillConfig`新增3007“精神鞭笞”：30米敌方目标、5秒引导、每1秒执行一次暗影伤害，共5跳；技能只使用1秒公共CD，没有额外技能CD。当前配置为每跳30点伤害，并按实际伤害的50%治疗施法者。
...
- 技能系统曾增加3006引导治疗，用来验证引导Tick、读条时停止平A、移动打断、公共CD和单技能排队；当前演示已将3006改为瞬发“恢复”，通过Buff 2002在24秒内每3秒恢复10点、共8次，持续效果仍不为每个Cast创建独立Timer或Update目标。
